# :warning: Please! Do not fork this project. You need to use [this guys and gals here](https://github.com/new/import) and copy [here](https://github.com/mrpoons-studio/MagiskOnWSA/), [here](https://github.com/codenamedpktbusiness/MagiskOnWSA/) or [here](https://github.com/mrpoons-studio/MagiskOnWSA/), or my project will be banned as GitHub policy. and will be like original developer @LSPosed original repo which is now inaccessible [here](https://github.com/LSPosed/MagiskOnWSA) as they get banned by GitHub's ToS and policies. See original developer @LSPosed stated below ⬇️. We will go private shortly as preventing forking and adding GitHub Actions function.
